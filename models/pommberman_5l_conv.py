...
class Pommberman(Model):
    ...
    def _build_layers_v2(self, input_dict, num_outputs, options):
        ...
        with tf.name_scope("pommber_vision"):
            vision_in = slim.conv2d(vision_in, 18, 2, 1, scope="conv_1")
            vision_in = slim.conv2d(vision_in, 18 * 2, 2, 1, padding="valid", scope="conv_2")
            vision_in = slim.conv2d(vision_in, 18 * 2, 2, 1, padding="valid", scope="conv_3")
            vision_in = slim.conv2d(vision_in, 18 * 2, 2, 1, padding="valid", scope="conv_4")
            vision_in = slim.conv2d(vision_in, 18 * 5, 5, 1, padding="valid", scope="conv_5")
